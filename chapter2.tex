...
\begin{proof}
  Let $\mathcal{A}_1, \cdots, \mathcal{A}_k$ be the smooth structures of $M_1, \cdots, M_k$.
  ...
  Then for each $i$, there exist $(U_i, \phi_i) \in \mathcal{A}_i$ and $(V_i, \psi_i) \in \mathcal{A}_i$ such that $x_i \in U_i$ and $\phi_i(U_i) \subset V_i$.
