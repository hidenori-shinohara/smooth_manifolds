...
\begin{customexer}{2.7(Prove Proposition 2.5)}\label{exercise_2_7}
...
\begin{proof}
  ...
  It might seem that we can apply (\ref{exercise_2_7}) to show that $f$ is smooth, but (\ref{exercise_2_7}) requires that $U \cap f^{-1}(V)$ be open in $M$.
