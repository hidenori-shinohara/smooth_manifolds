...
\begin{proof}
  ...
  \begin{enumerate}[label=(\alph*)]
    \item 
      ...
      \todo[inline,caption={}]{
        This problem is a little more complicated than it seems because we need to show that $U$ is a smooth manifold in order to say $F\mid_U$ is smooth.
        Exercise 1.44 is about that, so I should solve it first.
      }
  \end{enumerate}
\end{proof}
