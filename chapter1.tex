...
\begin{customprob}{1-7}
  ...
  \begin{enumerate}[label=(\alph*)]
    ...
    \item
      ...
      \end{align*}
    \item
      Compute the transition map $\tilde{\sigma} \circ \sigma^{-1}$ and verify that the atlas consisting of the two charts $(S^n \setminus \{ N \}, \sigma)$ and $(S^n \setminus \{ S \}, \hat{\sigma})$ defines a smooth structure on $S^n$.
    \item
