...
\begin{customthm}{3.10}\label{proposition_3_10}
...
\begin{customthm}{3.24}\label{proposition_3_24}
...
\begin{proof}
  This is a special case of (\ref{proposition_3_24}) where $t_0 = 0$.
\end{proof}
